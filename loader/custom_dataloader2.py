...
def dataloader(args):
    if args.data_type == 'cifar10':
        ...
        testset = custom_datasets.Custom_CIFAR10(root=args.data_path, train=False, download=True, transform=transform_test)
        ...
        test_loader = torch.utils.data.DataLoader(testset, pin_memory=True,
                                                   batch_size=args.batch_size,
                                                   sampler=None,
                                                   shuffle=True,
                                                   num_workers=args.workers)
        ...
        testset = custom_datasets.Custom_CIFAR100(root=args.data_path, train=False, download=True, transform=transform_test)
        ...
        testset = custom_datasets.Custom_ImageFolder(os.path.join(args.data_path,'test'), transform=transform_test)
